...
paratope_epitope_motif_interaction = function(){
...
degree_correlation = function(){
  ...
  ggplot(data=topnmdf) + 
    ...
    geom_text(mapping = aes(x=0, y=200, label = scor_label), size=7, hjust=0) + 
...
cross_reactivity_degree_cor = function(){
  ...
  outpdf('degree', 'mean_overlap_scatter', width = 12, height = 4)
