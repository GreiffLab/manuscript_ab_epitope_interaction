...
#production dir
prod_dir = '../../production_runs/take2'
...
embdims = [1] + [2**i for i in range(1,11, 2)]
...
for rep, embdim, unit in rep_emdim_units[:]:
    ...
    print('evaluating rep %s, embdim, %s, unit %s. run %s of %s' % (rep, embdim, unit, run_index, n))
    run_index +=1
